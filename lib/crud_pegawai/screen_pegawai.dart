...
class _PegawaiScreenState extends State<PegawaiScreen> {
  ...
  Future<ModelPegawai> fetchPegawai() async {
    final response = await http.get(Uri.parse('http://192.168.1.3/mobilesmt4/pegawai/getPegawai.php'));
  ...
  Future<void> addOrUpdatePegawai({required Datum pegawai}) async {
    String url = pegawai.id.isEmpty
        ? 'http://192.168.1.3/mobilesmt4/pegawai/addPegawai.php'
        : 'http://192.168.1.3/mobilesmt4/pegawai/updatePegawai.php';
  ...
  Future<void> deletePegawai(String id) async {
    final response = await http.post(
      Uri.parse('http://192.168.1.3/mobilesmt4/pegawai/deletePegawai.php'),
      body: {'id': id},
    );
