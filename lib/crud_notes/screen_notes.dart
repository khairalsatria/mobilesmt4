...
class _NotesScreenState extends State<NotesScreen> {
  ...
  Future<ModelNotes> fetchNotes() async {
    final response = await http.get(Uri.parse('http://192.168.1.3/mobilesmt4/notes/getNotes.php'));
  ...
  Future<void> addOrUpdateNote({required Datum note}) async {
    String url = note.id.isEmpty
        ? 'http://192.168.1.3/mobilesmt4/notes/addNotes.php'
        : 'http://192.168.1.3/mobilesmt4/notes/updateNotes.php';
  ...
  Future<void> deleteNote(String id) async {
    final response = await http.post(
      Uri.parse('http://192.168.1.3/mobilesmt4/notes/deleteNotes.php'),
      body: {'id': id},
    );
